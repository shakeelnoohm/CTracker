  ...
  return (
    <div className="login-container">
      <div className="login-card">
        ...
        <span className="college-logo">C-TRACKER</span>
        {/* <span className="name">Inventory Management System</span> */}
        <div className="login-form ">
          <form className="mt-8 space-y-8 w-full pb-8" onSubmit={submitHandler}>
            ...
            >
              ...
              <div>
                <input
                  ...
                  name="username"
                  required
                  className="mb-5 form-input  appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
